...
from maddrive_adas.utils.metrics import fitness
...
colors = Colors()  # create instance for 'from maddrive_adas.utils.plots import colors'
...
def plot_val_txt():  # from maddrive_adas.utils.plots import *; plot_val()
...
def plot_targets_txt():  # from maddrive_adas.utils.plots import *; plot_targets_txt()
...
def plot_val_study(
    file="", dir="", x=None
):  # from maddrive_adas.utils.plots import *; plot_val_study()
...
):  # from maddrive_adas.utils.plots import *; plot_evolve()
...
def plot_results(file="path/to/results.csv", dir=""):
    # Plot training results.csv. Usage: from maddrive_adas.utils.plots import *; plot_results('path/to/results.csv')
    save_dir = Path(file).parent if file else Path(dir)
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=""):
    # Plot iDetection '*.txt' per-image logs. from maddrive_adas.utils.plots import *; profile_idetection()
