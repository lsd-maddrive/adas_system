...
import numpy as np
from .common import Conv_Bn_Activation, YoloLayer, get_region_boxes, Upsample
...
class Yolov4Head(nn.Module):
    def __init__(self, output_ch, n_classes, strides, anchors, anchor_masks, inference):
        super().__init__()
        self.inference = inference
